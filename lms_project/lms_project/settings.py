...
from lms_project.config import get_env
...
SECRET_KEY = "django-insecure-ofzh(m&c@bgtpfivn#7!u#=n0t#uz8b==x616!8i9$_w1!ikgz"
...
REST_FRAMEWORK = {
    ...
    "PAGE_SIZE": get_env("PAGE_SIZE", 5, int),
    "DEFAULT_THROTTLE_RATES": {
        "borrow": get_env("BORROW_THROTTLE_RATE", default="3/day"),
    },
}
